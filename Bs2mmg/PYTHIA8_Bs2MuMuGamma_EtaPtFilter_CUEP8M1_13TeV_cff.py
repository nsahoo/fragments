...
generator = cms.EDFilter("Pythia8GeneratorFilter",
        ...
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bs_mumugamma.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bs2MuMuGamma_EtaPtFilter_CUEP8M1_13TeV_cff.py  $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bs --> mu+ mu- gamma , 13TeV, Tune CUETP8M1')
    )
...
decayfilter = cms.EDFilter(
    ...
    DaughterIDs     = cms.untracked.vint32(-13, 13, 22),  ## mu+, mu-, photon
