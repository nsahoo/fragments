...
generator = cms.EDFilter("Pythia8GeneratorFilter",
        ...
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bu_JpsiKstar_mumuKspi.dec'),  ## DEC file replaced !!
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bu2KstarJPsi_EtaPtFilter_CUEP8M1_13TeV_cff.py $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bu --> K*+(->Ks pi+) JPsi(mu+ mu-), 13TeV, Tune CUETP8M1')
    )
...
ProductionFilterSequence = cms.Sequence(generator*bufilter*jpsifilter*kstarfilter)
