...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bu2KstarMuMu_EtaPtFilter_CUEP8M1_13TeV_cff.py $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bu --> K*+(->Ks pi+) mu+ mu-, 13TeV, Tune CUETP8M1')
    )
...
decayfilter = cms.EDFilter(
        ...
        ParticleID      = cms.untracked.int32(521),  
        DaughterIDs     = cms.untracked.vint32(-13, 13, 323),  ## mu-, mu+, K*+
...
ProductionFilterSequence = cms.Sequence(generator*bufilter*decayfilter*kstarfilter)
