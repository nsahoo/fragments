...
generator = cms.EDFilter("Pythia8GeneratorFilter",
        ...
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bd_mumuKstar_mumuKpi.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bd2KstarMuMu_EtaPtFilter_CUEP8M1_13TeV_cff.py  $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bd --> mu+ mu- K*(892) (-> K+ pi-) , 13TeV, Tune CUETP8M1')
    )
