...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bd2JpsiKshort_EtaPtFilter_CUEP8M1_13TeV_cff.py  $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bd --> Jpsi(-> mu+ mu-) Ks(-> pi+ pi-) , 13TeV, Tune CUETP8M1')
    )
...
decayfilter = cms.EDFilter(
    ...
    ParticleID      = cms.untracked.int32(511),  ## Bd
    DaughterIDs     = cms.untracked.vint32(443, 310), ## JPsi, Ks                                                                                
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*jpsifilter*decayfilter)
