...
generator = cms.EDFilter("Pythia8GeneratorFilter",
        ...
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bu_Psi2SK.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bu2Psi2sK_EtaPtFilter_CUEP8M1_13TeV_cff.py $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bu --> Psi2S(-> mu+ mu-) K+ , 13TeV, Tune CUETP8M1')
    )
