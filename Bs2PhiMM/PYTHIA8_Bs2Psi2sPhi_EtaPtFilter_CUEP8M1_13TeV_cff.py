...
generator = cms.EDFilter("Pythia8GeneratorFilter",
        ...
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/Bs_Psi2Sphi_mumuKK.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/Generator/python/PYTHIA8_Bs2Psi2sPhi_EtaPtFilter_CUEP8M1_13TeV_cff.py  $'),
    annotation = cms.untracked.string('Summer16: Pythia8+EvtGen130 generation of Bs --> Psi2S(-> mu+ mu-) Phi(K+ K-) , 13TeV, Tune CUETP8M1')
    )
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*psi2sfilter*phifilter)
